...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
        ...
        <nav class="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-sm border-b border-primary-100">
            <div class="w-full px-6 lg:px-12">
                <div class="flex justify-between items-center h-16">
                    ...
                    <!-- Mobile Menu Button -->
                    <button @click="open = !open" class="md:hidden text-primary-600" x-data="{ open: false }">
